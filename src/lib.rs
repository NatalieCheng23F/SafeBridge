...
#[derive(Debug)]
pub struct SafeBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SafeBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SafeBridge processing");
    
    let mut processor = SafeBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SafeBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SafeBridgeProcessor::new(false);
